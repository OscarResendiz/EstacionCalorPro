// Todos los escudos UNO de mcufriend.com tienen el mismo pinout.
// es decir, pines de control A0-A4. Datos D2-D9. MicroSD D10-D13.
// Las pantallas táctiles normalmente son A1, A2, D7, D6 pero el orden varía
//
// Esta demostración debería funcionar con la mayoría de las bibliotecas TFT de Adafruit
// Si no estás usando un escudo, usa un constructor Adafruit completo()
// p.ej. Adafruit_TFTLCD tft(LCD_CS, LCD_CD, LCD_WR, LCD_RD, LCD_RESET);
...
void setup(void) 
{
  ...
  //g_identifier =0x9481;// 0x9329;                             // force ID
...
void loop(void) {
  ...
  if (tft.height() > 64) 
  {
    ...
    for (uint8_t cnt = 0; cnt < 4; cnt++) 
    {
      ...
      tft.println(" COLOR GRADES oscar");

...
#include <stdio.h>
#include <string.h>
#include "Librerias/ControlVelocidadAire/ControlVelocidadAire.hpp"
...
int main(void)
{
    ...
    while(1)
    {
    	...
    	//sprintf(cadena,"Valor= %4.2f Vcc conteo=%d\r\n",x, conteo);
    	sprintf(cadena,"Valor= %d Vcc conteo=%d\r\n",x, conteo);
    	print(cadena);
    	conteo++;
    	Delay_ms(500);
    }
...
void adc_config(void)
{
	...
	ADC_RegularChannelConfig(ADC1,ADC_Channel_3,1,ADC_SampleTime_55Cycles5); //PA6 entrada
